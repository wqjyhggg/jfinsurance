		...
		<div class="row">
			<div class="jfcard" style="float: left;vertical-align:top;position:absolute;bottom:5px;left:5px;width:320px;margin-top: 30px;">
				...
				<?php }elseif ($plan['product_short'] == "JFPL") { ?>
					<h4 class="text-center" style="background: #eee;"><span>JF Student Insurance Platinum</span></h4>
				...
				<?php }elseif ($plan['product_short'] == "JFP") { ?>
					<h4 class="text-center" style="background: #eee;"><span>JF Protection International Student to Canada</span></h4>
				<?php }else{ ?>
