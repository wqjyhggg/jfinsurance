  ...
  <div class="container" style="padding: 0 40px;">
    <div class="row" style="padding-top: 60px;">
      ...
      <div class="col-sm-5 text-left">
        <h2><?php if ($plan['status_id'] < 2) { ?>Quote<?php } else { ?>Confirmation<?php } ?> d’assurance</h2>
      </div>
    </div>
    ...
    <div class="row" style="margin-top: -15px;">
      <div class="col-sm-6 nopadding">
        ...
        <h4>Type de régime: <span><?php if ($plan['isfamilyplan'] == 1) {
                                echo "Family";
                              } else {
                                echo "Individual";
                              } ?></span>
        ...
        <h4>Déductible: <span>$<?php echo number_format($plan['deductible_amount'], 2); ?></span>
        </h4>
    ...
    <div class="row">
      <div class="col-sm-12 nopm special-note">
        <p class="small">Souscrit par Old Republic Insurance Company of Canada et administré par JF Insurance Agency Group Inc.</p>
      </div>
    </div>
  </div><!-- End Container -->
</body>
