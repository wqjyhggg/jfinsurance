	...
	<div class="container">	
		...
		<div class="row">
			<div class="col-sm-12 nopadding">
				...
				<p  class="nopm">We have processed your request to refund the policy of <span><b><?php echo $plan['policy']; ?></b></span>. We are pleased to provide you a refund for the policy.</p>
			</div>
		</div>
