...
<div class="main">
  ...
  <div class="info">
    ...
    <div class="info-card">
      ...
      <span class="info-lable">Student Name:<span>
      <?php } else { ?>
    ...
    <div class="info-card">
      <span class="info-lable">School Name:<span>
      <span class="info-text"><?php echo $plan['institution']; ?></span>
    </div>
    <div class="info-card">
      <span class="info-lable">School Full Address:<span>
      <span class="info-text"><?php echo $plan['institution_addr']; ?></span>
    </div>
    <div class="info-card">
