...
?>
	<div class="row">
		<div class="col-sm-12 nopm">
			...
			<p class="small" style="margin-top:2px;"><b>Including Stable Pre-existing Medical Condition Coverage.</b></p>
			<?php } else if ($plan['stable_condition'] == 2 ) { ?>
			<p class="small" style="margin-top:2px;"><b>Excluding Stable Pre-existing Medical Condition Coverage.</b></p>
			<?php } ?>
