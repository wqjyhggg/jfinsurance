  ...
  <div class="container" style="padding: 0 40px;">
    ...
    <div class="row">
      <div class="col-sm-12 nopm">
        ...
        <br />
        <p class="small" style="margin-top:2px;">Si vous remarquez des erreurs dans les renseignements ci-dessus ou si vous avez des questions, veuillez communiquer avec JF Insurance Agency Group Inc.<br />
        </p>
      </div>
    </div><br />
    <!--/div-->
