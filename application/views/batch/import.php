          ...
          <div class="x_content">
            ...
            <form action="<?php $action_url; ?>" id='uploadform' method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
              ...
              <div class="row">
                ...
                <div class="form-group col-sm-3">
                  <input class="btn btn-primary" type="button" id='checkfile' value="Check File" />
                </div>
              </div>
              <div class="row">
                <div class="form-group col-sm-12">
...
<script>
  $(document).ready(function() {
    ...
    $('#checkfile').click(function (e) {
      ...
      $('#loading').show();
      $('#alert_message').html('');
      var data = new FormData(document.getElementById("uploadform")); // <-- 'this' is your form element
      $.ajax({
