                    ...
                    <form method="post" class="form-horizontal" action='<?php echo $add_url; ?>'>
                      ...
                      <div class="row">  
                        <div class="form-group col-sm-12">
                          ...
                          <div class="input-group col-sm-12">
                              <input type="text" name="full_address" value="<?php if(!empty($plan['suite_number'])){echo  "Suite " . $plan['suite_number'] . " ";} ?><?php echo $plan['street_number'] . ' ' . $plan['street_name'] . ' ' . $plan['city'] . ', ' . $plan['province2'] . ', ' . $plan['postcode']; ?>" class="form-control" disabled />
                          </div>
                        </div>
