				...
				<div class="row">
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-light">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav mr-auto">
									...
									<li class="nav-item"><a class="nav-link border-menu" href="<?php echo base_url("user/login");?>"><?php echo $lang['buy_product'];?></a></li>
								</ul>
							</div>
						</nav>
					</div>
					<div class="col-md-6">
						<ul class="header-dropdown-block pull-right">
							...
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="language-image"><i class="fas fa-cog"></i><?php echo $lang['switch_language'];?></span> </a>
								<div
						...
						<div class="carousel-caption pt-5" data-aos="fade-down">
							...
							<div class="p-3">
								...
								<div class="banner-btn">
									<button type="button" onclick="location.href='<?php echo base_url("user/login");?>';" class="btn btn-primary btn-white text-uppercase btn-auto"><?php echo $lang['get_a_quote'];?></button>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-md-9">
					<h1 class="border-title mt-4 mb-2 ">
						<span class="border-green-bottom green-text text-uppercase"><?php echo $lang['text_about'];?></span> <span class="border-sub-title"><?php echo $lang['we_take_care'];?></span>
					</h1>
					<p><?php echo $lang['JF_intro'];?></p>
				</div>
			</div>
		</div>
	</section>
								...
								<div class="inner zig-padding">
									<div class="row justify-content-center">
										<div class="col-xl-6 col-lg-9 col-md-11  col-xs-12">
											<h3 class="green-text mb-3"><?php echo $lang['founder'];?></h3>
											<p><?php echo $lang['founder_text'];?></p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="outer  bg-green ">
							<div class="middle">
								<div class="inner zig-padding">
									<div class="row justify-content-center">
										<div class="col-xl-6 col-lg-9 col-md-11  col-xs-12">
											<h3 class="white-text mb-3"><?php echo $lang['mission'];?></h3>
											<p class="white-text"><?php echo $lang['mission_text'];?></p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="outer">
							<div class="middle">
								<div class="inner zig-padding">
									<div class="row justify-content-center">
										<div class="col-xl-6 col-lg-9 col-md-11  col-xs-12">
											<h3 class="green-text mb-3"><?php echo $lang['vision'];?></h3>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="double-title text-center">
						<h1 class="green-text m-0 pb-1 text-uppercase"><?php echo $lang['we_offer'];?></h1>
						<p><?php echo $lang['we_take_care'];?></p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="offer-block my-4 p-3 bg-green">
						...
						<h2 class="white-text m-0 pt-3 pb-2"><?php echo $lang['visitor_to_canada'];?></h2>
						<p class="white-text"><?php echo $lang['visitor_to_canada_text'];?></p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="offer-block my-4 p-3 bg-green">
						...
						<h2 class="white-text m-0 pt-3 pb-2"><?php echo $lang['inter_stu_to_canada'];?></h2>
						<p class="white-text"><?php echo $lang['inter_stu_to_canada_text'];?></p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="offer-block my-4 p-3 bg-green">
						...
						<h2 class="white-text m-0 pt-3 pb-2"><?php echo $lang['can_travel_out'];?></h2>
						<p class="white-text"><?php echo $lang['can_travel_out_text'];?></p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 text-center">
					<button type="button" onclick="location.href='<?php echo base_url("user/login");?>';" class="btn btn-primary border btn-white text-uppercase btn-auto"><?php echo $lang['get_a_quote'];?></button>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 pb-5 text-center">
						<h1 class="text-uppercase green-text"><?php echo $lang['contact_us'];?></h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6" data-aos="fade-right">
						<h1 class="pb-2 mb-3 border-bottom normal-font"><?php echo $lang['toronto_office'];?></h1>
						...
						<div class="address-line py-1">
							<div class="row">
								...
								<div class="col-md-10 col-lg-10 col-xl-11">
									<p>
										<span class="address-title"><?php echo $lang['phone'];?></span><a href="tel: 905-707-1512"> 905-707-1512</a>
									</p>
									<p>
										<span class="address-title"><?php echo $lang['fax'];?></span>905-707-1513
									</p>
									<p>
					...
					<div class="col-md-6" data-aos="fade-left">
						...
						<div class="address-line py-1">
							<div class="row">
								...
								<div class="col-md-10 col-lg-10 col-xl-11">
									<p>
										<span class="address-title"><?php echo $lang['phone'];?></span><a href="tel:604-232-0896">604-232-0896</a>
									</p>
									<p>
										<span class="address-title"><?php echo $lang['fax'];?></span>604-232-0897
									</p>
									<p>
										<span class="address-title"><?php echo $lang['toll_free'];?></span><a href="tel:1-877-232-0896">1-877-232-0896</a>
									</p>
									<p>
										<br />
									</p>
