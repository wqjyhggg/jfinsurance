...
class Downloads extends MY_Controller {
	...
	public function index()
	{
		...
		ksort($product_list);
		$fileName = array('_Brochure', '_ChineseBrochure', '_Benefit_Summary', '_Claim_Form', '_Claim_Procedure', '_Consent_Form', '_Policy', '_Medical_Questionnaire', '_Baggage_Claim_Form', '_Cancellation_Claim_Form', '_Medical_Claim_Form');
