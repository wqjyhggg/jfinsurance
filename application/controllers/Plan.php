...
class Plan extends MY_Controller {
	...
	private function psireturncommon($plan_id) {
		...
		$para['TransTime'] = $this->input->get('TransTime');
		$para['OrderID'] = $this->input->get('OrderID');
		$para['Approved'] = $this->input->get('Approved');
		$para['ReturnCode'] = $this->input->get('ReturnCode');
		$para['ErrMsg'] = $this->input->get('ErrMsg');
		$para['TaxTotal'] = $this->input->get('TaxTotal');
		$para['ShipTotal'] = $this->input->get('ShipTotal');
		$para['SubTotal'] = $this->input->get('SubTotal');
		$para['FullTotal'] = $this->input->get('FullTotal');
		$para['PaymentType'] = $this->input->get('PaymentType');
		$para['DebitType'] = $this->input->get('DebitType');
		$para['CardNumber'] = $this->input->get('CardNumber');
		$para['CardExpMonth'] = $this->input->get('CardExpMonth');
		$para['CardExpYear'] = $this->input->get('CardExpYear');
		$para['TransRefNumber'] = $this->input->get('TransRefNumber');
		$para['CardIDResult'] = $this->input->get('CardIDResult');
		$para['IPResult'] = $this->input->get('IPResult');
		$para['IPCity'] = $this->input->get('IPCity');
		$para['IPRegion'] = $this->input->get('IPRegion');
		$para['IPCountry'] = $this->input->get('IPCountry');
		$para['AVSResult'] = $this->input->get('AVSResult');
		$para['IssuerName'] = $this->input->get('IssuerName');
		$para['IssuerConfCode'] = $this->input->get('IssuerConfCode');
	...
	function detail($plan_id=0, $sekey='') {
		...
		$data['StoreKey'] = 'merchantcardcapture200024';
